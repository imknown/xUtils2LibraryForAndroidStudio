...
public class URLEncodedUtils {
	...
	/**
	 * Returns a list of {@link org.apache.http.NameValuePair NameValuePairs} as built from the URI's query portion. For example, a URI of http://example.org/path/to/file?a=1&b=2&c=3 would return a list of three NameValuePairs, one for a=1, one for b=2, and one for c=3.
	 * <p/>
	...
	/**
	 * Adds all parameters within the Scanner to the list of <code>parameters</code>. For example,a scanner containing the string <code>a=1&b=2&c=3</code> would add the {@link org.apache.http.NameValuePair NameValuePairs} a=1, b=2, and c=3 to the list of parameters.
	 *
	 * @param parameters
	 ...
	 * <p/>
	 * This list is the same as the {@code reserved} list in <a href="http://www.ietf.org/rfc/rfc2396.txt">RFC 2396</a> as augmented by <a href="http://www.ietf.org/rfc/rfc2732.txt">RFC 2732</a>
	 */
	 ...
	 * <p/>
	 * Uses the {@link #URLENCODER} set of characters, rather than the set; this is for compatibilty with previous releases, URLEncoder.encode() and most browsers.
	 *
	 * @param content
