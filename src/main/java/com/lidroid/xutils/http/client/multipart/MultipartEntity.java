...
public class MultipartEntity implements HttpEntity, UploadEntity {
	 ...
	 * @param charset
	 *            the character set to use, may be {@code null}, in which case {@link MIME#DEFAULT_CHARSET} - i.e. UTF-8 - is used.
	 */
	...
	/**
	 * Creates an instance using the specified {@link HttpMultipartMode} mode. Boundary and charset are set to {@code null}.
	 *
	 * @param mode
	 *            the desired mode
	 */
	...
	protected String generateContentType(final String boundary, final Charset charset) {
		...
		/*
		 * if (charset != null) { buffer.append("; charset="); buffer.append(charset.name()); }
		 */
