...
public class LruMemoryCache<K, V> {
	...
	/**
	 * @param maxSize
	 *            for caches that do not override {@link #sizeOf}, this is the maximum number of entries in the cache. For all other caches, this is the maximum sum of the sizes of the entries in this cache.
	 */
	...
	/**
	 * Caches {@code value} for {@code key}. The value is moved to the head of the queue. Default expiryTimestamp: Long.MAX_VALUE.
	 *
