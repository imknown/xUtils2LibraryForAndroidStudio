...
public class PauseOnScrollListener implements OnScrollListener {
	 ...
	 * @param pauseOnScroll
	 *            Whether {@linkplain BitmapUtils#pause() pause loading} during touch scrolling
	 * @param pauseOnFling
	 *            Whether {@linkplain BitmapUtils#pause() pause loading} during fling
	 */
	 ...
	 *            Your custom {@link android.widget.AbsListView.OnScrollListener} for {@linkplain android.widget.AbsListView list view} which also will be get scroll events
	 */
